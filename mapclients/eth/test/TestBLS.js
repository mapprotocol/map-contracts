...
describe('WeightedMultiSig', function () {
    ...
    //
    //     const WeightedMultiSig = await hre.ethers.getContractFactory('LightNode');
    ...
    //     await wms.initialize(threshold, addresss, g1List, weights, 0, 1000,verifyToolContractAddress);
    //
    // });
    ...
    //     const epoch = 0;
    //     assert(await wms.callStatic.checkSigTag(bits, message, sign, aggpk, epoch));
    // });
