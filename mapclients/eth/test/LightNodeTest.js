...
describe("LightNode start test", function () {
    ...
    //
    //
    //     let wmContract = await ethers.getContractAt("WeightedMultiSig",wmAddress);
    //
    ...
    it('delete committee member', async function () {
        ...
        const LightClientDelete = await ethers.getContractFactory("LightNode");
    ...
    it('should ', async function () {
        ...
        console.log(wmAddressDelete);

        let wm = await ethers.getContractAt("WeightedMultiSig",wmAddressDelete);

        // console.log("newAddress:" + wmAddressDelete);

        // let wmDelete = await ethers.getContractAt("WeightedMultiSig",wmAddressDelete);
        //
        //
        // console.log(await lightClientDelete.getValiditors());
        //
        //
        console.log("0000000000000000000000000000000000")
        console.log(await lightClientDelete.toBytes0(0x10));
