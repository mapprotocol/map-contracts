...
````
After the execution is successful, check whether the content of the map-contracts/mapclients/eth/deploy/configBack.js file is similar to the following
````
map-contracts/mapclients/eth/deploy/configBack.js
...
````
When using the following command network refers to the name of the network you need to deploy. See networks configuration in **hardhat.configBack.js** file for details
