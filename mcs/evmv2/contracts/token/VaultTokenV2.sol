...
contract VaultTokenV2 is IVaultTokenV2, Ownable,ERC20Burnable {
    ...
    function deposit(uint256 _fromChain, uint256 _amount, address _to) external override onlyOwner {
    ...
    function withdraw(uint256 _toChain, uint256 _amount, address _to) external override onlyOwner {
    ...
    function transferToken(uint256 _fromChain, uint256 _amount,  uint256 _toChain, uint256 _outAmount, uint256 _relayChain, uint256 _fee) external override onlyOwner {
