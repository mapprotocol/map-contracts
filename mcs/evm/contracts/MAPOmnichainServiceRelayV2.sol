...
contract MAPOmnichainServiceRelay is ReentrancyGuard, Initializable, Pausable, IMCSRelay, UUPSUpgradeable {
    ...
    function depositToken(address token, uint256 amount) external {
        ...
        _deposit(token, Utils.toBytes(msg.sender), payable(msg.sender), amount, bytes32(""), selfChainId);
    }
    ...
    function depositNative() external payable whenNotPaused {
        ...
        _deposit(wToken, Utils.toBytes(msg.sender), payable(msg.sender), amount, bytes32(""), selfChainId);
    }
