...
task("lightClientDeploy", "deploy LightNode proxy and init", require("./lightClientDeploy"))
...
task("setLedgerInfo", "LightNode set the LedgerInfo contract address", require("./setLedgerInfo")).addParam(
    "ledger",
    "LedgerInfo contract address"
);
...
task("setProvable", "LightNode set the Provable contract address", require("./setProvable")).addParam(
    "provable",
    "Provable contract address"
);
