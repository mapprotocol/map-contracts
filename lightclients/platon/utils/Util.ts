...
export async function getQuorumCert(hash: string, rpc: string) {
    ...
    let quorumCert = new QuorumCert(q.epoch, q.viewNumber, q.blockHash, q.blockNumber, q.blockIndex, q.signature, validatorSignBitMap, signedCount);
