...
module.exports = async function (hre:any) {
  ...
  console.log("LightNode salt:", LIGHTNODE_BTC_SALT);

  let factory = await ethers.getContractAt("IDeployFactory",DEPLOY_FACTORY)

  console.log("deploy factory address:",factory.address)

  let hash = await ethers.utils.keccak256(await ethers.utils.toUtf8Bytes(LIGHTNODE_BTC_SALT));
