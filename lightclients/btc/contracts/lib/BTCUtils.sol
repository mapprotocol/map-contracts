...
library BTCUtils {
    ...
    function extractTimestamp(bytes memory _header) internal pure returns (uint256) {
        return uint256(bytesToUint(reverseEndianness(extractTimestampLE(_header))));
    }
